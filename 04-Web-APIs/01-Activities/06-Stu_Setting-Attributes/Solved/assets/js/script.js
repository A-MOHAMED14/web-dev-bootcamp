...
for (var i = 0; i < siteTitles.length; i++) {
  ...
  siteTitles[i].style.color = "blue";
  siteTitles[i].style.fontWeight = "bolder";
  siteTitles[i].style.fontSize = "30px";
  siteTitles[i].style.paddingLeft = "10px";
  siteTitles[i].style.margin = "0";
}
